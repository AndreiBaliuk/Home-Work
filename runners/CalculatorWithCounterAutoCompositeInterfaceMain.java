...
import homework3.calcs.simple.CalculatorWithCounterAutoAgregatioInterface;

public class CalculatorWithCounterAutoCompositeInterfaceMain {

  public static void main(String[] args) {
    CalculatorWithCounterAutoAgregatioInterface calculator = new CalculatorWithCounterAutoAgregatioInterface();
